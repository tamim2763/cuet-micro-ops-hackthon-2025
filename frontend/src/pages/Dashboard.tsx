...
function Dashboard() {
  ...
  const { health, setHealth, loading, setLoading, error, setError } =
    useHealthStore();
  ...
  const handleSentryTest = async () => {
    ...
    try {
      ...
      captureMessage(
        "Sentry test completed - error captured successfully",
        "info",
      );
      toast.success(
        `Sentry test triggered! Check your Sentry dashboard.\nTrace ID: ${traceId}`,
      );
    } finally {
  ...
  const handleTracingTest = async () => {
    ...
    toast.success(`Tracing test completed!\nTrace ID: ${traceId}`, {
      duration: 5000,
      icon: "🔍",
    });
    ...
    <div className="space-y-8">
      ...
      <div className="card">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            ...
            onClick={() =>
              trackAction("dashboard.open_jaeger", { source: "button" })
            }
          >
            Open Jaeger UI
          </a>
      ...
      <div className="card">
        ...
        <p className="text-sm text-gray-600 mt-3">
          All actions on this page are tracked in a distributed trace. Use the
          trace ID to correlate frontend events with backend operations in
          Jaeger.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <div className="space-y-3 text-gray-600">
          <p>
            The core application structure is now set up. Here's what's been
            implemented:
          </p>
